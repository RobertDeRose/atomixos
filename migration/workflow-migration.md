...
- `pre-commit` `exception` — `HK_SKIP_STEPS=docs git commit -m "docs: reconcile migrated feature records"` — User approved a new post-Gate-4 docs-step exception for the separate design and delivered-record reconciliation checkpoint.
