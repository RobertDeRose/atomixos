...
nixos-lib.runTest {
  ...
  testScript = ''
    ...
    gateway.succeed("grep 'WARNING: units failed to start after sync: edgeproxy.service frontend-network.service app-data-volume.service myapp.service' /tmp/quadlet-sync/output.log")
