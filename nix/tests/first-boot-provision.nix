...
nixos-lib.runTest {
  ...
  testScript = ''
    ...
    gateway.succeed("grep 'WARNING: units failed to start after sync: edgeproxy.service myapp.service' /tmp/quadlet-sync/output.log")
