...
nixos-lib.runTest {
  ...
  testScript = ''
    ...
    gateway.succeed("test ! -f /test-state/rauc.log")
    gateway.succeed("grep 'ERROR: provisioning seed not found' /tmp/no-dev-fallback.log")
